function [tip_traj, whole_traj, contact_traj] = getPath1tube(tube, obstacles, traj, iniState)
    ...
    p0 = obstacles{1}.p0;
    obstacles{1}.T_history(:,:,1) = [eye(3), p0; 0 0 0 1];
    ...
    for i = 2:nt
        ...
        obstacles{1}.T_history(:,:,end+1) = [RotZ(alphaI), p0+[0;0;betaI]; 0 0 0 1];
